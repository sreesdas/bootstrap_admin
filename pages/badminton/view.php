...
<head>
  ...
  <title>Annual Sports | Badminton</title>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php
					...
					$sql = "SELECT NAME, CPF, DOB, MEN_SINGLES_BLW45, MEN_DOUBLES_BLW45, MIXED_DOUBLES_BLW45 FROM badminton_tbl 
							where (MEN_SINGLES_BLW45 != '' or MEN_DOUBLES_BLW45 != '')
							UNION
							SELECT NAME,CPF,DOB,MEN_SINGLES_ABV45,MEN_DOUBLES_ABV45,MIXED_DOUBLES_ABV45 FROM `badminton_tbl` 
							WHERE (MEN_SINGLES_ABV45 != '' OR MEN_DOUBLES_ABV45 != '')";
					...
					while($row = $result->fetch_assoc()) {
						...
						echo "<td>" . $row['CPF'] . "</td>";
						echo "<td>" . $row['NAME'] . "</td>";
						echo "<td>" . $row['MEN_SINGLES_BLW45'] . "</td>";
						echo "<td>" . $row['MEN_DOUBLES_BLW45'] . "</td>";
						echo "<td>" . $row['MIXED_DOUBLES_BLW45'] . "</td>";
						echo "</tr>";
					}
					}
				?>
			...
			<div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
					...
					$sql = "SELECT NAME, CPF, DOB, WOMEN_SINGLES_BLW45, WOMEN_DOUBLES_BLW45 FROM badminton_tbl 
					where PARTICIPANT_NAME = '' AND (WOMEN_SINGLES_BLW45 != '' OR WOMEN_DOUBLES_BLW45 != '' )
					UNION
					SELECT NAME, CPF, DOB, WOMEN_SINGLES_ABV45, WOMEN_DOUBLES_ABV45 FROM badminton_tbl 
					where PARTICIPANT_NAME = '' AND (WOMEN_SINGLES_ABV45 != '' OR WOMEN_DOUBLES_ABV45 != '' )
					UNION
					SELECT PARTICIPANT_NAME, CPF, DOB, WOMEN_SINGLES_BLW45, WOMEN_DOUBLES_BLW45 FROM badminton_tbl WHERE
					PARTICIPANT_NAME != '' AND (WOMEN_SINGLES_BLW45 != '' OR WOMEN_DOUBLES_BLW45 != '')";
					$result = $conn->query($sql);
					if ($result->num_rows > 0) {
					// output data of each row
					while($row = $result->fetch_assoc()) {
						...
						echo "<td>" . $row['NAME'] . "</td>";
						echo "<td>" . $row['DOB'] . "</td>";
						echo "<td>" . $row['WOMEN_SINGLES_BLW45'] . "</td>";
						echo "<td>" . $row['WOMEN_DOUBLES_BLW45'] . "</td>";
						echo "</tr>";
					}
					}
				?>
