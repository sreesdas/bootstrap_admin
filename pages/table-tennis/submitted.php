...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	$mixed = isset($_POST['mixed'])? $_POST['mixedPartner'] : '';
	
	//$wosa45 = isset($_POST['wosa45'])? $_POST['wosa45'] : '';
	//$wosb45 = isset($_POST['wosb45'])? $_POST['wosb45'] : '';
	
	$women = isset($_POST['women'])? 'Participating' : '';
	...
	$kids	= isset($_POST['kids'])? 'Participating' : '';
	...
	$sql = "INSERT INTO tt_tbl VALUES($cpf,'$name','$regfor','$participant','$formatted_dob','$mesa45','$meda45',
																							'$mesb45','$medb45',
																							'$women','$mixed','$kids',
																							 now())";
